...
<template>
    <div>
        ...
        <div class="w-96 p-4 bg-gray-900 rounded-lg mx-auto my-32">
            ...
            <UAlert v-bind:key="e" v-for="e in errors" title="Uh Oh!" :description="e.message"
                icon="i-heroicons-exclamation-circle" color="red" variant="outline" class="mb-4" />

            <UForm :state="formState" :validate="validateForm" @submit="registerUser">
            ...
            <UButton color="gray" class="w-full justify-center" @click="navigateTo('/portal/login')">
